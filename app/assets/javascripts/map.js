...
var renderDesignerMap = function (designers) {
	...
	$.each(designers, function(i, designer) {
		...
		var info_content = '<h4><a href="/designers/'+designer.to_param+'">'+designer.full_name+'</a></h4>';
		...
		if (shot_image_url !== undefined && shot_image_url !== null && shot_image_url.length > 0) {
			...
			image_content='<a href="/designers/'+designer.to_param+'"><img style="width:160px;" src="'+shot_image_url+'"/></a>'+
